                    ...
                    confirm: {
                        ...
                        callback: function(){
                            if($('#data_atendimento_' + sessoes_id).val() == 0) {
                                ...
                                $.ajax({
                                    url: 'http://saudeemcasapi.com/sistema/admin/consultas/mudar_presenca_consulta/' + sessoes_id + '/' + presenca + '/' + data_atendimento,
                                    type: "POST",
                                    dataType: 'json',
                                    context: this,
                                    data: { 
                                    ...
                                    success: function(data) {
                                        ...
                                        //window.location.href = "/saudemcasa/admin/consultas/sessoes/" + consultas_id + '/' + atendimentos_id;
                                        }
                                    },
