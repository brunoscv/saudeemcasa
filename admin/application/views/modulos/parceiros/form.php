		...
		<div class="header-body">
			<div class="row align-items-center py-4">
				...
				<div class="col-lg-6 col-5 text-right">
					<a href="<?php echo base_url(); ?>parceiros" class="btn btn-sm btn-neutral">Listagem</a>
				</div>
			</div>
		</div>
	</div>
...
<div class="main-content" id="panel">
	<div class="container-fluid mt--6">
				...
				<div class="card-wrapper">
					<div class="card">
						...
						<div class="card-header">
							<h3 class="mb-0">Parceiros / <?php echo (@$item->id) ? "Editar" : "Adicionar" ?> </h3>
						</div>
						<div class="col-md-12">
						...
						<!-- Card body -->
						<div class="card-body">
							<form id="form_parceiros" class="needs-validation"
								...
								<a href="<?php echo site_url("parceiros")?>" class="btn btn-outline-default ml-auto">
									Cancelar
								</a>
							</form>
						</div>
		...
		<script type="text/javascript" src="<?php echo base_url(); ?>assets/modulos/parceiros/js.js"></script>
		<script type="text/javascript" src="<?php echo base_url(); ?>assets/modulos/parceiros/validate.js"></script>
