					...
					<div class="row" data-container="all">
						...
						<div class="col-md-8" data-container="main">
							<div class="panel panel-default">
								<div class="panel-heading clearfix">
									<h4 class="panel-title">Users
										/ <?php echo (@$item->id) ? "Editar" : "Adicionar" ?> </h4>
									<a href="<?php echo site_url("users/"); ?>" class="btn btn-primary pull-right"><span
												class="fa fa-list"></span> Ir para a Listagem</a>
								</div>
								<div class="panel-body" style="margin-top:10px;">
									<?php echo $this->load->view('layout/messages.php'); ?>
									<form id="form_users" action="<?php echo current_url(); ?>" class="form-horizontal"
										...
										<div class="form-group">
											...
											<div class="col-sm-10">
												<input name="usuario" type="text" id="usuario" class="form-control"
													   value="<?php echo set_value("usuario", @$item->usuario) ?>"/>
										...
										<div class="form-group">
											...
											<div class="col-sm-10">
												...
												<?php endif; ?>
												<input name="senha" type="password" id="senha" <?php echo $classHtml; ?>
										...
										<?php if (@$item->imagem): ?>
											<div class="form-group imagem-upload">
												<label class="col-sm-2 control-label" for="imagem">Imagem
													Questão</label>
												<div class="col-sm-6">
													<div class="imagem-questao">
														<img src="<?php echo base_url() . 'public/uploads/usuarios/' . @$item->imagem; ?>"
															 width=100 height=100>
														<!-- <input type="hidden" name="imagem" value="<?php echo @$item->imagem; ?>"> -->
													</div>
												</div>
												<div class="col-sm-2">
													<button type="button" class="btn btn-danger remover-imagem">
														Remover
													</button>
												</div>
											</div>
							...
							<script type="text/javascript"
									src="<?php echo base_url(); ?>assets/modulos/users/js.js"></script>
							<script type="text/javascript"
									src="<?php echo base_url(); ?>assets/modulos/users/validate.js"></script>
						</div>
					</div>
				</div>
			</div>
