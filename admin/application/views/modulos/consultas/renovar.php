						...
						<input name="id" type="hidden" id="id" class="form-control" value="<?php echo set_value("id", @$item->id) ?>" />
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									...
									'data-size="7" data-live-search="true" class="form-control fill_selectbtn_in own_selectbox" id="pacientes" required="" disabled=""'); ?>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									...
									'data-size="7" data-live-search="true" class="form-control" id="profissionais"required="" disabled=""'); ?>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input name="data_inicio" type="text" id="data_inicio" required="" class="form-control" />
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input name="data_fim" type="text" id="data_fim" required="" class="form-control" />
