		...
		<div class="header-body">
			<div class="row align-items-center py-4">
				...
				<div class="col-lg-6 col-5 text-right">
					<a href="<?= base_url()?>documentos/" class="btn btn-sm btn-neutral"><i class="fa fa-plus"></i> Todos</a>
				</div>
			</div>
		</div>
	</div>
				...
				<div class="card-header">
					...
					<form class="form-horizontal" method="post">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" disabled="" class="form-control" value="<?php echo set_value("descricao", $item->descricao); ?>" name="descricao" id="descricao" placeholder="ex: efortes">
							</div>
						</div>
						<div class="form-group">
