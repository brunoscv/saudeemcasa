...
<div class="main-content" id="panel">
	<div class="container-fluid mt--6">
				...
				<div class="card-wrapper">
					<div class="card">
						...
						<div class="card-header">
							<h3 class="mb-0">Proprietários / <?php echo (@$item->id) ? "Editar" : "Adicionar" ?> </h3>
						</div>
						<div class="col-md-12">
						...
						<!-- Card body -->
						<div class="card-body">
							<form id="form_proprietarios" class="needs-validation"
								...
								<div class="card mb-4">
									...
									<div class="card-body">
										...
										<div class="form-row">
											...
											<div class="col-md-3 mb-3">
												<label class="form-control-label" for="estado_civil">Estado
													Civil</label>
								...
								<div class="card mb-4">
									...
									<div class="card-body">
										<div class="form-row">
											<div class="col-md-3 mb-3">
												<label class="form-control-label" for="forma_pagamento">Forma de
													Pagamento</label>
											...
											<div class="col-md-2 mb-3">
												<label class="form-control-label" for="codigo_operacao">Código de
													Operação</label>
												<input type="text" class="form-control" id="codigo_operacao"
										...
										<div class="form-row">
											<div class="col-md-6 mb-3">
												<label class="form-control-label" for="nome_titular">Nome do
													Titular</label>
											...
											<div class="col-md-6 mb-3">
												<label class="form-control-label" for="cpf_titular">CPF do
													Titular</label>
												<input type="text" class="form-control" id="cpf_titular"
													   name="cpf_titular"
										...
										<div class="form-row">
											...
											<div class="col-md-4 mb-3">
												<label class="form-control-label" for="orgao_expedidor">Órgão
													Expedidor</label>
												<input type="text" class="form-control" id="orgao_expedidor"
											...
											<div class="col-md-4 mb-3">
												<label class="form-control-label" for="data_expedicao">Data de
													Expedição</label>
												<input type="date" class="form-control" id="data_expedicao"
													   name="data_expedicao"
								...
								<div class="card mb-4">
									...
									<div class="card-body">
										<div class="form-row">
											...
											<div class="col-md-4 mb-3">
												<label class="form-control-label" for="ramo_atividade">Ramo de
													atividade</label>
												<input type="text" class="form-control" id="ramo_atividade"
													   name="ramo_atividade"
											...
											<div class="col-md-4 mb-3">
												<label class="form-control-label" for="renda_mensal">Renda
													mensal</label>
												<input type="text" class="form-control" id="renda_mensal"
													   name="renda_mensal"
									...
									<div class="card-body">
										<div class="form-row">
											<div class="col-md-4 mb-3">
												...
												<input type="text" class="form-control" id="nome_conjuge"
													   name="nome_conjuge"
											...
											<div class="col-md-3 mb-3">
												...
												<input type="text" class="form-control" id="cpf_conjuge"
													   name="cpf_conjuge"
											...
											<div class="col-md-3 mb-3">
												...
												<input type="text" class="form-control" id="rg_conjuge"
													   name="rg_conjuge"
											...
											<div class="col-md-2 mb-3">
												<label class="form-control-label" for="orgao_expedidor_conjuge">Órgão
													expedidor</label>
												<input type="text" class="form-control" id="orgao_expedidor_conjuge"
										...
										<div class="form-row">
											<div class="col-md-4 mb-3">
												...
												<input type="text" class="form-control" id="celular_conjuge"
											...
											<div class="col-md-4 mb-3">
												<label class="form-control-label"
													   for="telefone_conjuge">Telefone</label>
												<input type="text" class="form-control" id="telefone_conjuge"
											...
											<div class="col-md-4 mb-3">
												...
												<input type="text" class="form-control" id="email_conjuge"
													   name="email_conjuge"
													   placeholder="Ex: email@exemplo.com"
										...
										<div class="form-row">
											<div class="col-md-4 mb-3">
												...
												<input type="text" class="form-control" id="nacionalidade_conjuge"
											...
											<div class="col-md-4 mb-3">
												...
												<input type="text" class="form-control" id="sexo_conjuge"
													   name="sexo_conjuge"
													   placeholder="Ex: M/F"
											...
											<div class="col-md-4 mb-3">
												<label class="form-control-label"
													   for="profissao_conjuge">Profissão</label>
												<input type="text" class="form-control" id="profissao_conjuge"
								...
								<a href="<?php echo site_url("proprietarios") ?>"
								   class="btn btn-outline-default ml-auto">
									Cancelar
								</a>
							</form>
						</div>
		...
		<script type="text/javascript" src="<?php echo base_url(); ?>assets/modulos/proprietarios/js.js"></script>
		<script type="text/javascript" src="<?php echo base_url(); ?>assets/modulos/proprietarios/validate.js"></script>
