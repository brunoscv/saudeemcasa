		...
		<div class="header-body">
			<div class="row align-items-center py-4">
				...
				<div class="col-lg-6 col-5 text-right">
					<a href="<?php echo base_url(); ?>proprietarios/criar" class="btn btn-sm btn-neutral">Novo</a>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="col">
			<div class="card">
				...
				<div class="card-header">
					<h3 class="mb-0">Proprietários</h3>
				</div>
				<div class="col-md-12">
				...
				<div class="table-responsive py-4">
					<table class="table table-flush" id="datatable-basic">
						...
						<tbody>
						<?php foreach ($listaProprietarios as $item): ?>
							<tr>
								...
								<td class="td-actions">
									<a href="<?php echo site_url("proprietarios/editar/" . $item->id); ?>"
									   class="btn btn-small btn-primary"><i class="fa fa-edit"> </i>
									</a>
									<a href="<?php echo site_url("proprietarios/delete/" . $item->id); ?>"
