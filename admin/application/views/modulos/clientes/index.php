		...
		<div class="header-body">
			<div class="row align-items-center py-4">
				...
				<div class="col-lg-6 col-5 text-right">
					<a href="<?php echo base_url(); ?>clientes/criar" class="btn btn-sm btn-neutral">Novo</a>
				</div>
			</div>
		</div>
	</div>
					...
					<table class="table table-flush" id="datatable-basic">
						...
						<?php foreach ($listaClientes as $item): ?>
							<tr>
								...
								<td class="td-actions">
									<a href="<?php echo site_url("clientes/editar/" . $item->id); ?>"
									   class="btn btn-small btn-primary"><i class="fa fa-edit"> </i>
									</a>
									<a href="<?php echo site_url("clientes/delete/" . $item->id); ?>"
