		...
		<div class="header-body">
			<div class="row align-items-center py-4">
				...
				<div class="col-lg-6 col-5 text-right">
					<a href="<?php echo base_url(); ?>clientes" class="btn btn-sm btn-neutral">Listagem</a>
				</div>
			</div>
		</div>
	</div>
				...
				<div class="card-wrapper">
					<div class="card">
						...
						<div class="card-header">
							<h3 class="mb-0">Clientes / Remover </h3>
						</div>
						<!-- Card body -->
						<div class="card-body">
							...
							<a href="<?php echo site_url("clientes")?>" class="btn btn-outline-default ml-auto">
								Cancelar
							</a>
						</div>
					</div>
					...
					<div class="modal-content bg-gradient-danger">
						<form id="form_imovel" class="form-horizontal" method="post">
							...
							<div class="modal-footer">
								...
								<a href="<?php echo site_url("clientes")?>" class="btn btn-link text-white ml-auto">
									Cancelar
								</a>
							</div>
						</form>
