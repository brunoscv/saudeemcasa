        ...
        <div class="col-md-12">
            <div class="panel panel-white has-shadow">
				<div class="panel-heading clearfix">
					<h4 class="panel-title">pacientes / Remover</h4>
				...
				<div class="panel-body" style="margin-top:10px;">
					...
					<form id="form_usuario" class="form-horizontal" method="post">
						...
						<div class="form-group">
							<label class="col-sm-2 control-label" for="nome_pac">Nome Paciente</label>
							<div class="col-sm-10">
								<input type="text" disabled="" class="form-control" value="<?php echo set_value("nome_pac", $item->nome_pac); ?>" name="nome_pac" id="nome_pac" placeholder="ex: efortes">
							</div>
						</div>
