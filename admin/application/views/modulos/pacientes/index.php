		...
		<div class="header-body">
			<div class="row align-items-center py-4">
				...
				<div class="col-lg-6 col-5 text-right">
					<a href="<?= base_url()?>pacientes/criar" class="btn btn-sm btn-neutral"><i class="fa fa-plus"></i> Novo</a>
						...
						<tbody>
							<?php foreach($listaPacientes as $item): ?>
								<tr>
									...
									<td class="">
										<a class="mr-2" href="<?php echo site_url("pacientes/editar/".$item->id); ?>"><i class='fa fa-pen'></i></a>
										<a class="" href="<?php echo site_url("pacientes/delete/". $item->id); ?>"><i class='fa fa-trash'></i></a>
									</td>
								</tr>
							<?php endforeach; ?>
						</tbody>
